...
class Vial_Network:
    ...
    def predict_and_display(self, figsize=(12, 8)):
        ...
        print(f"vial_df with shape: {vial_df.shape}:\n\n{vial_df}\n\n")
        print(f"irrel_vials_indices:\n{irrel_vials_indices}\n\nself.irrel_vials:\n{self.irrel_vials}\n\n")
        # vial_df.drop(irrel_vials_indices, axis=0, inplace=True)
        vial_df.drop(irrel_vials_indices, axis=0, inplace=True, errors='ignore')
